...
//                                                                      
    ...
    cout << "Encrypted value of " << a << " is " << rotate_char(a, r, Encrypt) << endl ;
    rotate_char(rotate_char(a, r, Encrypt), r, Decrypt) ;
    cout << "Decrypted value of " << rotate_char(a, r, Encrypt) << " is " << rotate_char(rotate_char(a, r, Encrypt), r, Decrypt) << endl ;
}
